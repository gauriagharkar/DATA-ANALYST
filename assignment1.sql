...
RENAME TABLE countries TO big_countries;
set sql_safe_updates=0;
update big_countries set captial='New Delhi' where population=1326;
select*from big_countries;*/

/*Que.5 Create Product,Suppliers and Stock Table*/

/*create database product
create table product(
product_id int auto_increment,product_name not null unique auto_increment
